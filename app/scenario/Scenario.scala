...
object Scenario extends Enum[Scenario] {
  ...
  final case object SuccessChipAndPin      extends Scenario {
    val value = "success_chip_and_pin"; val description = "Success chip & pin with all data on receipt"
  }
  final case object SuccessChipAndPinMulti extends Scenario {
    val value       = "success_chip_and_pin_multi_card";
    val description = "Success chip & pin with no sequenceNumber on receipt"
  }

  // FlowType1
  final case object SuccessNoVerification extends Scenario {
    val value = "success_no_verification"; val description = "Success no verification card with all data on receipt"
  }
  final case object SuccessNoReceipt      extends Scenario {
  ...
  final case object DeclinedNotAuthorisedNotVerified  extends Scenario {
  ...
  final case object DeclinedNotAuthorisedNotVerified2 extends Scenario {
  ...
  final case object DeclinedInvalidCard  extends Scenario {
  ...
  final case object DeclinedInvalidCard2 extends Scenario {
  ...
  final case object DeclinedValidationFailed extends Scenario {
  ...
  final case object DeclinedBinCheckFailed   extends Scenario {
    val value = "declined_bin_check_failed"; val description = "Declined/Bin check failed"
  }
  final case object DeclinedNoReceipt        extends Scenario {
    val value = "declined_no_receipt"; val description = "Declined no receipt"
  }
  final case object DeclinedPedDisconnected  extends Scenario {
    val value = "declined_ped_disconnected"; val description = "Declined PED disconnected"
  }

  final case object FallbackPosDecision extends Scenario {
  ...
  final case object CancelledOnPedIcc      extends Scenario {
    val value = "cancelled_ped_icc"; val description = "Chip&Pin path with transaction cancelled by user on ped"
  }
  final case object CancelledByBarclaycard extends Scenario {
  ...
  final case object SuccessChipAndPinMasterCard      extends Scenario {
    val value = "success_chip_and_pin_mastercard"; val description = "Success chip & pin with different card"
  }
  final case object SuccessNoMerchantNumberInReceipt extends Scenario {
