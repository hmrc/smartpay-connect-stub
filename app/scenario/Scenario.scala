...
object Scenario extends Enum[Scenario] {
  ...
  given OFormat[Scenario] = FormatUtil(
    ...
    "SuccessChipAndPinMulti"            -> SuccessChipAndPinMulti,
    "SuccessNoVerification"             -> SuccessNoVerification,
    "SuccessNoReceipt"                  -> SuccessNoReceipt,
    "DeclinedNotAuthorisedNotVerified"  -> DeclinedNotAuthorisedNotVerified,
    "DeclinedNotAuthorisedNotVerified2" -> DeclinedNotAuthorisedNotVerified2,
    "DeclinedInvalidCard"               -> DeclinedInvalidCard,
    "DeclinedInvalidCard2"              -> DeclinedInvalidCard2,
    "DeclinedValidationFailed"          -> DeclinedValidationFailed,
    "DeclinedBinCheckFailed"            -> DeclinedBinCheckFailed,
    "DeclinedNoReceipt"                 -> DeclinedNoReceipt,
    "DeclinedPedDisconnected"           -> DeclinedPedDisconnected,
    "FallbackPosDecision"               -> FallbackPosDecision,
    "CancelledOnPedIcc"                 -> CancelledOnPedIcc,
    "CancelledByBarclaycard"            -> CancelledByBarclaycard,
    "SuccessChipAndPinMasterCard"       -> SuccessChipAndPinMasterCard,
    "SuccessNoMerchantNumberInReceipt"  -> SuccessNoMerchantNumberInReceipt
  )()
  ...
  //  //FlowType8, ReceiptType 5
  //  case object SuccessNoVerificationPreAuth2 extends StubPath { val value = "success_no_verification_pre_auth2"; val description = "Success no chip & pin card with no authCode, startDate on receipt" }
